...
<template>
  <Teleport :to="teleportTarget">
    <FloatingPopover class="chat-sketch-canvas-popover" :open="Boolean(content)" :anchor="popoverAnchor" :placement="activePopover === 'clear' ? 'bottom' : ['view', 'background', 'ratio'].includes(activePopover) ? 'left' : 'auto'" :variant="activePopover === 'view' ? 'pill' : 'default'" @close="closePopover">
